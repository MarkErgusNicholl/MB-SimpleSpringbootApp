...
import com.markergus.mainserver.util.logging.LoggingService;
...
public class LoggingServiceImpl implements LoggingService {
    ...
    public void displayReq(HttpServletRequest request, Object body) {
        ...
        if(!Objects.isNull(body)) {
            reqMessage.append(" body = [").append(gson.toJson(body)).append("]");
        }

        log.info("log Request: {} Time: {}", reqMessage, LocalTime.now());
    }
    ...
    public void displayResp(HttpServletRequest request, HttpServletResponse response, Object body) {
        ...
        respMessage.append(" responseBody = [").append(gson.toJson(body)).append("]");

        log.info("log Response: {} Time: {}", respMessage, LocalTime.now());
    }
